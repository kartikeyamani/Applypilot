...
# Hard cap on total jobs discovery will accumulate in the DB before stopping
# early. Keeps demo/local runs fast and bounded. Set APPLYPILOT_DISCOVERY_CAP=0
# to disable and crawl everything configured in searches.yaml.
DISCOVERY_CAP = int(os.environ.get("APPLYPILOT_DISCOVERY_CAP", "50") or "50")
